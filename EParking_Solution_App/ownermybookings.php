...
// executing query
$query_json ="SELECT * FROM `table_bookings` JOIN table_park on table_bookings.parking_id=table_park.parking_id JOIN table_location on table_location.location_id=table_park.location_id where owner='$email'";
